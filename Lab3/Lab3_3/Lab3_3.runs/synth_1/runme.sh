...
HD_PWD='C:/Users/tomjamf/Lab3_3/Lab3_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_adder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_adder_4bit.tcl
