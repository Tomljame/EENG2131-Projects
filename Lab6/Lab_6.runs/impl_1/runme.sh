...
HD_PWD='C:/Users/tomjamf/Lab_6/Lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentFourDigits_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegmentFourDigits_FPGA.tcl -notrace
