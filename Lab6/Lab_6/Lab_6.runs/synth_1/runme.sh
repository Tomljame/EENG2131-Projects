...
HD_PWD='C:/Users/tomjamf/Lab_6/Lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentFourDigits_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSegmentFourDigits_FPGA.tcl
